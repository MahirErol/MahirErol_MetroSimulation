...
class Istasyon:
    def __init__(self, idx: str, ad: str, hat: str):  # _init_ -> __init__
        self.idx = idx
        self.ad = ad
        self.hat = hat
...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        kuyruk = deque([(baslangic, [baslangic], None)])
        ziyaret_edildi = {baslangic}
        
        while kuyruk:
            current, path, aktarma_hatti = kuyruk.popleft()
            ...
            for komsu, _ in current.komsular:
                if komsu not in ziyaret_edildi:
                    ...
                    if aktarma_hatti and komsu.hat != aktarma_hatti:
                        kuyruk.append((komsu, yeni_path, komsu.hat))
                    else:
                        kuyruk.append((komsu, yeni_path, aktarma_hatti))
